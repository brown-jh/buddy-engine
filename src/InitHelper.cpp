...
VkCommandBuffer InitHelper::beginSingleTimeCommands()
{
...
void InitHelper::endSingleTimeCommands(VkCommandBuffer commandBuffer)
{
...
void InitHelper::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
{
...
void InitHelper::createTextureImage()
{
    VkBuffer stagingBuffer;
    VkDeviceMemory stagingBufferMemory;
    void* data;
    int texWidth, texHeight, texChannels;
    //stbi_uc* pixels = stbi_load("src/textures/shmog.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
...
void InitHelper::createDepthResources()
{
...
VkFormat InitHelper::findDepthFormat()
{
...
bool InitHelper::hasStencilComponent(VkFormat format)
{
    return format == VK_FORMAT_D32_SFLOAT_S8_UINT || format == VK_FORMAT_D24_UNORM_S8_UINT;
}

VkFormat InitHelper::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features)
{
...
void InitHelper::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
{
...
void InitHelper::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) 
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
namespace std {
    template<> struct hash<InitHelper::Vertex> {
        size_t operator()(InitHelper::Vertex const& vertex) const {
...
void InitHelper::loadModel()
{
    ...
    std::cout << "finished loading model with " << vertices.size() << " vertices\n";
}
...
void InitHelper::createTextureSampler()
{
...
VkImageView InitHelper::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags)
{
...
void InitHelper::createTextureImageView()
{
...
void InitHelper::updateUniformBuffer(uint32_t currentImage)
{
    ...
    ubo.model = glm::rotate(glm::mat4(1.0f), glm::radians(15.0f), glm::vec3(0.0f, 0.0f, 1.0f)) * glm::translate(glm::mat4(1.0f), glm::vec3(y, x, 0.0f));
    ubo.view = glm::lookAt(glm::vec3(30.0f, 30.0f, 30.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
    
    ubo.proj = glm::perspective(glm::radians(45.0f), swapChainExtent.width / (float) swapChainExtent.height, 0.1f, 256.0f);
    ubo.proj[1][1] *= -1;
